...
AVAILABLE_VOICES = [
    ...
    "aura-2-aurelia-de", "aura-2-lara-de", "aura-2-fabian-de",
    "aura-2-kara-de",
    # ── Aura-2 Dutch ────────────────────────────────────────
    ...
    "aura-2-cinzia-it", "aura-2-cesare-it", "aura-2-perseo-it",
    "aura-2-demetra-it",
    # ── Aura-2 Japanese ─────────────────────────────────────
...
class TTSRequest(BaseModel):
    ...
    voice: str = Field(
        ...
        description=f"Deepgram Aura-2 voice model. Options: {', '.join(AVAILABLE_VOICES)}",
    )
